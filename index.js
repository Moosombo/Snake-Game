...
// Change velocity value based on what key is pressed
...
// Player changes direction on each key press
...
const initGame = () =>{
    ...
    // When the snake eats his food
    if (snakeX === foodX && snakeY === foodY){
        updateFoodPosition();
        snakeBody.push([foodY, foodX]); //Add food to the snake's body array
        score++;
    ...
    // Shifting forward values in snake by 1
